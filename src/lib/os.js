...
exports.Formula = exports.Ingredient = exports.TYPE_WATER = exports.TYPE_OTHER = exports.TYPE_STARTER = exports.TYPE_FLOUR = void 0;
const TYPE_FLOUR = 'flour';
exports.TYPE_FLOUR = TYPE_FLOUR;
const TYPE_STARTER = 'starter';
exports.TYPE_STARTER = TYPE_STARTER;
const TYPE_OTHER = 'other';
exports.TYPE_OTHER = TYPE_OTHER;
const TYPE_WATER = 'water';
exports.TYPE_WATER = TYPE_WATER;
const KNOWN_TYPES = new Set([TYPE_FLOUR, TYPE_STARTER, TYPE_WATER]);
...
class Formula {
  constructor(ingredients, strict, quiet) {
    ...
    this.ingredients = ingredients.map(ingredient => {
      const realIngredient = ingredient instanceof Ingredient ? ingredient : new Ingredient(ingredient); // Track certain ingredients by type for validation.
...
this formula.`);
  ...
  hydration() {
    ...
    let waterAmount = 0.0;
    let flourAmount = 0.0; // Total hydration is the baker's percentage of water content to dry
  ...
  setHydration(h) {
    const {
      ingredients,
      denominator
    } = this; // Compute weights of formula without considering water.
    ...
    const missingWaterWeight = Math.max(0, h * fixedFlourWeight - fixedWaterWeight); // Update the water ingredient with this weight.

    let waterIngredient = ingredients[waterIndex]; // Add water ingredient if it was missing (though validation should
    // have caught this).
    ...
    waterIngredient.percentage = missingWaterWeight; // Update total weight.
